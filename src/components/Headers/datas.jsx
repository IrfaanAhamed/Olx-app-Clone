...
export function HeaderButtons() {
  ...
  const buttonsWithDefaults = remainingButtons.map((btn) => ({
    ...btn,
    onclick: btn.onclick || (() => {}) // Provide noop for undefined actions
  }));
    ...
    <div>
      {remainingButtons.map((item, i) => (
        <div
          ...
          className="hover:bg-slate-200 flex my-1 py-2 rounded-md cursor-pointer"
        >
